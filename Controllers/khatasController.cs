...
namespace NeverCore.Controllers
{
    public class khatasController : Controller
    {
        ...
        public khatasController(NeverCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.khata != null ? 
                          ...
                          Problem("Entity set 'NeverCoreContext.khata'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'NeverCoreContext.khata'  is null.");
            }
            var khata = await _context.khata.FindAsync(id);
            if (khata != null)
            {
