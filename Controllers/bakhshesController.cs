...
namespace NeverCore.Controllers
{
    public class bakhshesController : Controller
    {
        ...
        public bakhshesController(NeverCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.bakhsh != null ? 
                          ...
                          Problem("Entity set 'NeverCoreContext.bakhsh'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'NeverCoreContext.bakhsh'  is null.");
            }
            var bakhsh = await _context.bakhsh.FindAsync(id);
            if (bakhsh != null)
            {
