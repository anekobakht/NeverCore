...
namespace NeverCore.Controllers
{
    ...
    public class neversController : Controller
    {
        ...
        private readonly NeverCoreContext _context;

        public neversController(NeverCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var q = _context.v_never.ToList();
              return _context.v_never != null ? 
                          View(await _context.v_never.ToListAsync()) :
                          Problem("Entity set 'NeverCoreContext.never'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'NeverCoreContext.never'  is null.");
            }
            var never = await _context.never.FindAsync(id);
            if (never != null)
            {
