...
namespace NeverCore.Controllers
{
    public class jensiatsController : Controller
    {
        ...
        public jensiatsController(NeverCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.jensiat != null ? 
                          ...
                          Problem("Entity set 'NeverCoreContext.jensiat'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'NeverCoreContext.jensiat'  is null.");
            }
            var jensiat = await _context.jensiat.FindAsync(id);
            if (jensiat != null)
            {
