...
namespace NeverCore.Controllers
{
    public class mobilesController : Controller
    {
        ...
        public mobilesController(NeverCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.mobile != null ? 
                          ...
                          Problem("Entity set 'NeverCoreContext.mobile'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'NeverCoreContext.mobile'  is null.");
            }
            var mobile = await _context.mobile.FindAsync(id);
            if (mobile != null)
            {
